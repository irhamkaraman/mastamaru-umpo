...
@section('content')
    <div class="mentor-dashboard-page min-h-screen">
        ...
        @endif
            ...
            <!-- Menu Card Tambahan (Terbit Sertifikat & Peserta) -->
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl shadow-xl p-6 md:p-8 mb-8 text-white relative overflow-hidden">
                <div class="absolute inset-0 opacity-10">
                    <svg class="absolute right-0 bottom-0 h-full w-1/2" viewBox="0 0 100 100" preserveAspectRatio="none" fill="currentColor">
                        <polygon points="100,100 0,100 100,0" />
                    </svg>
                </div>
                <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        <h3 class="text-xl md:text-2xl font-bold mb-2 flex items-center">
                            <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            Terbit Sertifikat & Daftar Peserta
                        </h3>
                        <p class="text-blue-100 max-w-lg text-sm md:text-base">
                            Lihat seluruh peserta pada kelompok Anda, cek riwayat absensi dan perolehan poin mereka, serta terbitkan sertifikat untuk peserta yang dinyatakan LULUS.
                        </p>
                    </div>
                    <a href="{{ route('mentor.participants') }}" class="w-full md:w-auto text-center inline-flex items-center justify-center bg-white text-blue-700 hover:bg-blue-50 px-6 py-3 rounded-xl font-bold shadow-lg transition-transform hover:scale-105">
            ...
            <div class="mentor-sessions-panel bg-white rounded-3xl shadow-2xl p-6 md:p-8 mb-8 border border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 space-y-4 md:space-y-0">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="mentor-live-pill hidden md:flex items-center bg-green-50 px-4 py-2 rounded-xl border border-green-200">
