...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="max-w-lg w-full text-center">
        ...
        <div class="mb-8">
            <div class="relative">
                <!-- Main 404 Text -->
                <div class="text-8xl sm:text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-4">
                    404
                </div>
                
                <!-- Floating Elements -->
                <div class="absolute -top-4 -left-4 w-8 h-8 bg-blue-200 rounded-full animate-bounce" style="animation-delay: 0.1s;"></div>
                <div class="absolute -top-2 -right-6 w-6 h-6 bg-indigo-200 rounded-full animate-bounce" style="animation-delay: 0.3s;"></div>
                <div class="absolute -bottom-2 left-8 w-4 h-4 bg-purple-200 rounded-full animate-bounce" style="animation-delay: 0.5s;"></div>
            </div>
        </div>
        ...
        <div class="mt-12 p-6 bg-white rounded-xl shadow-lg border border-gray-100">
            ...
            <p class="text-gray-600 text-sm mb-4">
                Jika Anda yakin halaman ini seharusnya ada, silakan hubungi administrator atau coba beberapa saran berikut:
            </p>
        ...
        <div class="mt-8 text-xs text-gray-400">
            Error Code: 404 | {{ now()->format('d M Y, H:i:s') }}
        </div>
    </div>
</div>
@endsection